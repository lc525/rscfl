...
\texttt{getrusage()} call, \texttt{perf}, and \texttt{ftrace}. Other tools such
as \texttt{iotop} or \texttt{netstat} use information exposed through
...
With those use cases in mind, \pname{ }is designed to give applications full
...
\pname{ }uses this logical structure in identifying suitable probing points for
