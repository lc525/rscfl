...
The kernel module manages the list of buffers by intercepting scheduler operations: on each
task switch it needs to look for the accounting buffer of the task that starts running. An index
