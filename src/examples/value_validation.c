...
int main(int argc, char *argv[])
{
  ...
  if ((sockfd_1 = socket(AF_INET, SOCK_STREAM, 0)) < 0) goto soc_err;
  ...
  if (connect(sockfd_1, (struct sockaddr *)&serv_addr_1, sizeof(serv_addr_1)) <
      0) {
  ...
  if ((sockfd_2 = socket(AF_INET, SOCK_STREAM, 0)) < 0) goto soc_err;
  ...
  if (connect(sockfd_2, (struct sockaddr *)&serv_addr_2, sizeof(serv_addr_2)) <
      0) {
