 ...
 *
 * Small changes (includes, defines) for using this in a kernel module were done
 * by Lucian Carata: also in public domain.
 *
                        ...
                        int len)
{
  ...
  /* We're now aligned. Process in aligned blocks. Specialise for each possible
   * carry count */
  end = ptr + len / 4 * 4;
